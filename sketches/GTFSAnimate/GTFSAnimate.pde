...
// Input csv file
String inputFile = "data/california_except_santacruz.csv"; // entire day

// How many frames?
int totalFrames = 1600;
...
void setup(){
  ...
  clock = loadImage("data/clock_icon.png");
  clock.resize(0, 35);
  calendar = loadImage("data/calendar_icon.png");
...
void loadData(){
  ...
  for (TableRow row : tripTable.rows()) {
   ...
   // Delay so everythign gets a chance to load fully
  //delay(10000);
}
